...
<!-- 顶部阅读进度条 -->
<div class="evelina-progress" id="evelina-progress"></div>

<!-- ===================== Hero 区 ===================== -->
<div class="evelina-hero" markdown>

<div class="evelina-hero__avatar">📚</div>

# <span class="evelina-hero__title">Evelina's Notebook</span>

<p class="evelina-hero__subtitle">
浙江大学 · 信息安全专业<br>
这里收录我的课程笔记、实验报告与知识整理 ——<br>
从离散数学到 CPU 设计，从数据结构到大学物理 🌌
</p>

<div class="evelina-hero__tags">
  <span class="evelina-tag">🛡 Information Security</span>
  <span class="evelina-tag">🏫 ZJU</span>
  <span class="evelina-tag">💻 CS & Systems</span>
  <span class="evelina-tag">📐 Math & Physics</span>
</div>

</div>

<!-- ===================== 信息条 ===================== -->
<div class="evelina-info">
  <div class="evelina-info__item">🐙 <b>GitHub</b>：Evelina-IS</div>
  <div class="evelina-info__item">🎓 <b>校区</b>：ZJU</div>
  <div class="evelina-info__item">🛡 <b>专业</b>：信息安全</div>
  <div class="evelina-info__item">✨ <b>持续更新中</b></div>
</div>
...
<a class="evelina-card" href="https://github.com/Evelina-IS/Evelina_personal_web">
  <span class="evelina-card__icon">✏️</span>
  <div class="evelina-card__title">编辑本站</div>
  <div class="evelina-card__desc">在 GitHub 上提交 Issue 或 PR 共建笔记</div>
</a>
...
- **introduction**：this web contains Evelina's classnotes, diaries, etc.
- 本站基于 [MkDocs Material](https://squidfunk.github.io/mkdocs-material/) 构建，支持中英双语、KaTeX 数学公式、代码高亮与评论互动。
- 发现错误或想补充内容？欢迎在每页底部评论区留言，或直接在 GitHub 上提 PR ✨
